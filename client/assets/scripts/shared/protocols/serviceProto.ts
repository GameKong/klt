...
import { ReqRoomCreate as ReqRoomCreate_1, ResRoomCreate as ResRoomCreate_1 } from './room/admin/PtlRoomCreate';
...
export interface ServiceType {
    api: {
        ...
        "match/admin/RoomServerJoin": {
            req: ReqRoomServerJoin,
            res: ResRoomServerJoin
        },
        "match/admin/UserInfo": {
            req: ReqUserInfo,
            res: ResUserInfo
        },
        "match/MatchStart": {
    ...
    msg: {
        "room/admin/RoomUpdateState": MsgRoomUpdateState,
        "room/client/RoleMove": MsgRoleMove,
        "room/client/RoleState": MsgRoleState,
        "room/server/Chat": MsgChat,
        "room/server/RoleAttack": MsgRoleAttack,
        "room/server/RoleJoin": MsgRoleJoin,
        "room/server/RoleLeave": MsgRoleLeave,
        "room/server/RoleMove": MsgRoleMove_1,
        "room/server/RoleRevive": MsgRoleRevive,
        "room/server/RoomRoleState": MsgRoomRoleState
    }
}
