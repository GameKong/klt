 ...
 */
function unload() {
    console.log("ExcelToJson unload");
}
...
exports.methods = {
    async excelToJson() {
        exports.config = await Editor.Profile.getProject("excel-to-json-ts");
        Editor.Profile.setConfig("excel-to-json-ts", "foo1", "testtest!!");
